...
javac -cp "./lib/*" -d ./build/web/WEB-INF/classes/ ./src/java/ControladoresServlets/*.java ./build/web/WEB-INF/generated-sources/servicios/*.java
echo "Binarios compilados!"
echo "Empaquetando..."
cd ./build/web/
jar -cvf ../culturarteWebApp.war .
